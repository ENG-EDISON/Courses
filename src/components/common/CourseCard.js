...
const EnrolledBadge = () => <span className="coursecard-badge enrolled">Enrolled</span>;
        ...
        <Link to={getCourseLink()} className="coursecard-link">
          ...
          <div className="coursecard-image-container">
            ...
            <div className="coursecard-badges">
              ...
              {validatedCourse.is_enrolled && <EnrolledBadge />}
            </div>
          ...
          <div className="coursecard-content">
            ...
            {/* BOTTOM ROW - Lessons + Price on same line */}
            <div className="coursecard-bottom-row">
              {/* LESSONS COUNT - Left side */}
                ...
                <div className="coursecard-pricing">
                  <div className="coursecard-price-container">
                    {priceInfo.displayPrice === 0 ? (
                      <span className="coursecard-free-badge">Free</span>
                    ) : (
                      <>
            ...
            {/* ENROLLED MESSAGE - Full width below */}
            {validatedCourse.is_enrolled && (
